...
const replaceWords = (str) => {
    ...
    for(let count = 0 ;count<replace.length ;count++){
        if (replace[count]==='I'){
            replace.splice(count,1,'We');
        }
        else if (replace[count]==='am'){
            replace.splice(count, 1, 'are');
        }
        else if (replace[count]==='was'){
             replace.splice(count,1,'were');
        }
    }
    return replace.join(' ');
}
